...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-ep-488-erd-s-problem-488-5c65f800-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/EP-488"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-ep-488-erd-s-problem-488-5c65f800-v1",
      "problem_contract_sha256": "76c401d073b402da71e142c56ef9bd3f9983d555ec2f91dfc46ace361b56bf76",
      "problem_id": "problem:um-ep-488-erd-s-problem-488-5c65f800",
      "route_id": "route:um-ep-488-erd-s-problem-488-5c65f800-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-ep-488-erd-s-problem-488-5c65f800-source-fidelity-01",
      "graph_id": "graph:um-ep-488-erd-s-problem-488-5c65f800-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-ep-488-erd-s-problem-488-5c65f800-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-ep-488-erd-s-problem-488-5c65f800-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Let $A$ be a finite set and $ B=\\{ n \\geq 1 : a\\mid n\\textrm{ for some }a\\in A\\}. $ Is it true that, for every $m>n\\geq \\max(A)$, $ \\frac{\\lvert B\\cap [1,m]\\rvert }{m}< 2\\frac{\\lvert B\\cap [1,n]\\rvert}{n}? $"
          },
          "statement_sha256": "4748875b160050a46178ad50afc16869f9cb5690793226de9448a6c97bd494db"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-ep-488-erd-s-problem-488-5c65f800-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-ep-488-erd-s-problem-488-5c65f800-root",
      "route_id": "route:um-ep-488-erd-s-problem-488-5c65f800-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-ep-488-a1e8f0ccb00b",
        "url": "https://www.unsolvedmath.com/problems/EP-488"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
